    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans">
      ...
      <nav className="w-full bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-bold text-xl tracking-tight text-slate-900">kelas front end B</span>
        </div>
        <div className="space-x-4">
          ...
          <a onClick={()=> {
            if (title === "kelas front end B") {
              setTitle("kelas front end A");
            } else {
              setTitle("kelas front end B");
            }
          }} href="#about" className="text-sm font-medium text-slate-600 hover:text-indigo-600">About</a>
